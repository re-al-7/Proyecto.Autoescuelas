...
{
    public partial class abmVehiculo : Page
    {
        ...
        protected void btnEditaGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (objPag != null)
                {
                    objPag.placa_vehiculo = txtEdit_placa_vehiculo.Text;
                    objPag.color_vehiculo = txtEdit_color_vehiculo.Text;
                    objPag.modelo_vehiculo = txtEdit_modelo_vehiculo.Text;
                    objPag.marca_vehiculo = txtEdit_marca_vehiculo.Text;
                    objPag.capacidad_tonelaje = txtEdit_capacidad_tonelaje.Text;
                    objPag.capacidad_personas = txtEdit_capacidad_personas.Text;
        ...
        protected void btnNewGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                var miSession = new CSessionHandler();
                var rn = new RnVehIculos();
                var objPag = new EntVehIculos();
                objPag.id_autoescuelas = int.Parse(ddlid_autoescuela.SelectedValue);
                objPag.placa_vehiculo = txtNew_placa_vehiculo.Text;
                objPag.color_vehiculo = txtNew_color_vehiculo.Text;
                objPag.modelo_vehiculo = txtNew_modelo_vehiculo.Text;
                objPag.marca_vehiculo = txtNew_marca_vehiculo.Text;
                objPag.capacidad_tonelaje = txtNew_capacidad_tonelaje.Text;
                objPag.capacidad_tonelaje = txtNew_capacidad_tonelaje.Text;
        ...
        protected void dtgListado_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            try
            {
                if (e.CommandName.Equals("detalles"))
                {
                    ...
                    dv.RowFilter = EntVehIculos.Fields.id_autoescuelas + " = " + strId;
                ...
                else if (e.CommandName.Equals("modificar"))
                {
                    ...
                    if (objPag != null)
                    {
                        ...
                        txtEdit_placa_vehiculo.Text = objPag.placa_vehiculo ;
                        txtEdit_color_vehiculo.Text = objPag.color_vehiculo;
                        txtEdit_modelo_vehiculo.Text = objPag.modelo_vehiculo ;
                        txtEdit_marca_vehiculo.Text = objPag.marca_vehiculo ;
                        txtEdit_capacidad_tonelaje.Text = objPag.capacidad_tonelaje ;
                        txtEdit_capacidad_personas.Text = objPag.capacidad_personas ;
        ...
        private DataTable CargarDataTable()
        {
            ...
            {
                var miSession = new CSessionHandler();
                var rnListadoDatos = new RnVehIculos();
                var dtDatos = rnListadoDatos.ObtenerDataTable(EntVehIculos.Fields.id_autoescuelas, ddlid_autoescuela.SelectedValue);
