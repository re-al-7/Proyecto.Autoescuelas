<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="abmSucursal.aspx.cs" Inherits="Autoescuelas.Web.AUT.abmSucursal" %>
            ...
            <div class="panel-body">
                ...
                <div class="dataTable_wrapper">
                    <asp:GridView ID="dtgListado" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:BoundField ReadOnly="True" DataField="direccion_sucursal" HeaderText="Direccion" ShowHeader="false">
                                <ItemStyle HorizontalAlign="Justify"></ItemStyle>
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </asp:BoundField>
                            <asp:BoundField ReadOnly="True" DataField="telefono_sucursal" HeaderText="Telefono" ShowHeader="false">
                                <ItemStyle HorizontalAlign="Justify"></ItemStyle>
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </asp:BoundField>
                            <asp:BoundField ReadOnly="True" DataField="id_usuario" HeaderText="Responsable" ShowHeader="false">
                                <ItemStyle HorizontalAlign="Justify"></ItemStyle>
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="Acciones">
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="ImbModificar" CommandName="modificar" CommandArgument='<%# Bind("id_sucursal") %>' runat="server"
                                                    ToolTip="Modificar el registro" 
                                                    CssClass="btn btn-primary btn-circle" Text="<i class='fa fa-edit'></i>"/>

                                    <asp:LinkButton ID="ImbEliminar" CommandName="eliminar" CommandArgument='<%# Bind("id_sucursal") %>' runat="server"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <asp:TextBox id="txtNew_direccion_sucursal" required=""
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox id="txtNew_telefono_sucursal" required=""
                        ...
                        <div class="form-group">
                            <label id="lblNew_id_usuario" runat="server">Responsable:</label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox id="txtEdit_direccion_sucursal" required=""
                                         data-parsley-maxlength="512"
                                         data-parsley-minlength="3"
                                         onkeypress="return textUtil.allowChars(this,event,true)" validtipo="letras"
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox id="txtEdit_telefono_sucursal" required=""
                                         data-parsley-maxlength="60"
                                         data-parsley-minlength="3"
                                         onkeypress="return textUtil.allowChars(this,event,true)" validtipo="letras"
                                         data-parsley-group="validation-edit"
                        ...
                        <div class="form-group">
                            <label id="Label1" runat="server">Responsable:</label>
                            <asp:DropDownList ID="ddlEdit_id_usuario" runat="server"
                                              class="form-control selectpicker" data-live-search="true"
                                              data-none-selected-text="No existen datos" 
                                              data-select-on-tab="true" data-size="7" CssClass="form-control">
                            </asp:DropDownList>
