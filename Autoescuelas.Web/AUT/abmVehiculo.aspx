<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="abmVehiculo.aspx.cs" Inherits="Autoescuelas.Web.AUT.abmVehiculo" %>
            ...
            <div class="panel-body">
                ...
                <div class="dataTable_wrapper">
                    <asp:GridView ID="dtgListado" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:BoundField ReadOnly="True" DataField="marca_vehiculo" HeaderText="Marca" ShowHeader="false">
                                <ItemStyle HorizontalAlign="Justify"></ItemStyle>
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </asp:BoundField>
                            <asp:BoundField ReadOnly="True" DataField="modelo_vehiculo" HeaderText="Modelo" ShowHeader="false">
                                <ItemStyle HorizontalAlign="Justify"></ItemStyle>
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </asp:BoundField>
                            <asp:BoundField ReadOnly="True" DataField="placa_vehiculo" HeaderText="Placa" ShowHeader="false">
                                <ItemStyle HorizontalAlign="Justify"></ItemStyle>
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </asp:BoundField>
                            <asp:BoundField ReadOnly="True" DataField="color_vehiculo" HeaderText="Color" ShowHeader="false">
                                <ItemStyle HorizontalAlign="Justify"></ItemStyle>
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </asp:BoundField>
                            <asp:BoundField ReadOnly="True" DataField="capacidad_tonelaje" HeaderText="Cap.Ton." ShowHeader="false">
                                <ItemStyle HorizontalAlign="Justify"></ItemStyle>
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </asp:BoundField>
                            <asp:BoundField ReadOnly="True" DataField="capacidad_personas" HeaderText="Nro.Pasaj." ShowHeader="false">
                                <ItemStyle HorizontalAlign="Justify"></ItemStyle>
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="Acciones">
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="ImbModificar" CommandName="modificar" CommandArgument='<%# Bind("id_vehiculo") %>' runat="server"
                                                    ToolTip="Modificar el registro" 
                                                    CssClass="btn btn-primary btn-circle" Text="<i class='fa fa-edit'></i>"/>

                                    <asp:LinkButton ID="ImbEliminar" CommandName="eliminar" CommandArgument='<%# Bind("id_vehiculo") %>' runat="server"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <asp:TextBox id="txtNew_marca_vehiculo" required=""
                                         ...
                                         runat="server" MaxLength="120">
                            </asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label id="Label4" runat="server">Modelo:</label>
                            <asp:TextBox id="txtNew_modelo_vehiculo" required=""
                                         data-parsley-maxlength="120"
                                         data-parsley-minlength="3"
                                         onkeypress="return textUtil.allowChars(this,event,true)" validtipo="letras"
                                         data-parsley-group="validation-new"
                        ...
                        <div class="form-group">
                            <label id="Label5" runat="server">Placa:</label>
                            <asp:TextBox id="txtNew_placa_vehiculo" required=""
                        ...
                        <div class="form-group">
                            <label id="Label6" runat="server">Color:</label>
                            <asp:TextBox id="txtNew_color_vehiculo" required=""
                        ...
                        <div class="form-group">
                            <label id="Label7" runat="server">Capacidad Tonelaje:</label>
                            <asp:TextBox id="txtNew_capacidad_tonelaje" required=""
                        ...
                        <div class="form-group">
                            <label id="Label10" runat="server">Nro Pasajeros:</label>
                            <asp:TextBox id="txtNew_capacidad_personas" required=""
            ...
            <ContentTemplate>
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label id="Label1" runat="server">Marca:</label>
                            <asp:TextBox id="txtEdit_marca_vehiculo" required=""
                                         data-parsley-maxlength="120"
                                         data-parsley-minlength="3"
                                         onkeypress="return textUtil.allowChars(this,event,true)" validtipo="letras"
                        ...
                        <div class="form-group">
                            <label id="Label8" runat="server">Modelo:</label>
                            <asp:TextBox id="txtEdit_modelo_vehiculo" required=""
                                         data-parsley-maxlength="120"
                                         data-parsley-minlength="3"
                                         onkeypress="return textUtil.allowChars(this,event,true)" validtipo="letras"
                                         data-parsley-group="validation-edit"
                        ...
                        <div class="form-group">
                            <label id="Label9" runat="server">Placa:</label>
                            <asp:TextBox id="txtEdit_placa_vehiculo" required=""
                                         data-parsley-maxlength="15"
                                         data-parsley-minlength="3"
                                         onkeypress="return textUtil.allowChars(this,event,true)" validtipo="letras"
                                         data-parsley-group="validation-edit"
                        ...
                        <div class="form-group">
                            <label id="Label11" runat="server">Color:</label>
                            <asp:TextBox id="txtEdit_color_vehiculo" required=""
                                         data-parsley-maxlength="60"
                                         data-parsley-minlength="3"
                                         onkeypress="return textUtil.allowChars(this,event,true)" validtipo="letras"
                                         data-parsley-group="validation-edit"
                        ...
                        <div class="form-group">
                            <label id="Label12" runat="server">Capacidad Tonelaje:</label>
                            <asp:TextBox id="txtEdit_capacidad_tonelaje" required=""
                                         data-parsley-maxlength="10"
                                         data-parsley-minlength="1"
                                         onkeypress="return textUtil.allowChars(this,event,true)" validtipo="numeros"
                                         data-parsley-group="validation-edit"
                        ...
                        <div class="form-group">
                            <label id="Label13" runat="server">Nro Pasajeros:</label>
                            <asp:TextBox id="txtEdit_capacidad_personas" required=""
                                         data-parsley-maxlength="3"
                                         data-parsley-minlength="1"
                                         onkeypress="return textUtil.allowChars(this,event,true)" validtipo="numeros"
                                         data-parsley-group="validation-edit"
